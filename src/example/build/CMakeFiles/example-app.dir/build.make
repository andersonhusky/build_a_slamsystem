...
CMakeFiles/example-app.dir/example-app.cpp.o: ../example-app.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/hongfeng/CV/build_a_slam_bymyself/src/example/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/example-app.dir/example-app.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example-app.dir/example-app.cpp.o -c /home/hongfeng/CV/build_a_slam_bymyself/src/example/example-app.cpp
...
CMakeFiles/example-app.dir/example-app.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/hongfeng/CV/build_a_slam_bymyself/src/example/example-app.cpp > CMakeFiles/example-app.dir/example-app.cpp.i
...
CMakeFiles/example-app.dir/example-app.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/hongfeng/CV/build_a_slam_bymyself/src/example/example-app.cpp -o CMakeFiles/example-app.dir/example-app.cpp.s
...
example-app: /usr/local/lib/libopencv_dnn.so.3.4.5
example-app: /usr/local/lib/libopencv_ml.so.3.4.5
example-app: /usr/local/lib/libopencv_objdetect.so.3.4.5
example-app: /usr/local/lib/libopencv_shape.so.3.4.5
example-app: /usr/local/lib/libopencv_stitching.so.3.4.5
example-app: /usr/local/lib/libopencv_superres.so.3.4.5
example-app: /usr/local/lib/libopencv_videostab.so.3.4.5
example-app: /usr/local/lib/libopencv_viz.so.3.4.5
example-app: /home/hongfeng/libtorch/lib/libtorch.so
example-app: /home/hongfeng/libtorch/lib/libc10.so
example-app: /usr/local/cuda-11.1/lib64/stubs/libcuda.so
example-app: /usr/local/cuda-11.1/lib64/libnvrtc.so
...
example-app: /usr/local/lib/libopencv_highgui.so.3.4.5
example-app: /usr/local/lib/libopencv_photo.so.3.4.5
example-app: /usr/local/lib/libopencv_video.so.3.4.5
example-app: /usr/local/lib/libopencv_videoio.so.3.4.5
example-app: /usr/local/lib/libopencv_imgcodecs.so.3.4.5
example-app: /usr/local/lib/libopencv_imgproc.so.3.4.5
example-app: /usr/local/lib/libopencv_core.so.3.4.5
example-app: /home/hongfeng/libtorch/lib/libc10_cuda.so
example-app: /home/hongfeng/libtorch/lib/libc10.so
example-app: /usr/local/cuda-11.1/lib64/libcufft.so
example-app: /usr/local/cuda-11.1/lib64/libcurand.so
example-app: /usr/local/cuda-11.1/lib64/libcublas.so
example-app: /usr/local/cuda-11.1/lib64/libcudnn.so
example-app: /usr/local/cuda-11.1/lib64/libnvToolsExt.so
example-app: /usr/local/cuda-11.1/lib64/libcudart.so
example-app: CMakeFiles/example-app.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/hongfeng/CV/build_a_slam_bymyself/src/example/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable example-app"
